                            ...
                            <form action="" method="post">
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input" type="text" placeholder="Nama Tempat Makan" name="kode_kriteria">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input" type="text" placeholder="Nama Tempat Makan" name="nm_kriteria">
                                        <span class="icon is-small is-left">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input" type="text" placeholder="Nama Tempat Makan" name="bobot">
                                        <span class="icon is-small is-left">
